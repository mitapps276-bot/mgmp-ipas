...
<head>
    ...
    <!-- SEO Meta Tags -->
    <title>SI-LIAK - MGMP IPAS Kota Denpasar</title>
    <meta name="description" content="Sistem Informasi Learning Integration & Analitik Kinerja (SI-LIAK). Wadah kolaborasi Musyawarah Guru Mata Pelajaran (MGMP) IPAS Kota Denpasar untuk ekosistem pembelajaran inovatif.">
    <meta name="keywords" content="SI-LIAK, MGMP, IPAS, Denpasar, Pendidikan, Guru, e-Learning, Platform Kolaborasi Guru, Repositori Materi">
    <meta name="author" content="MGMP IPAS Kota Denpasar">
    ...
    <script type="application/ld+json">
    {
      ...
      "@type": "Organization",
      "name": "MGMP IPAS Kota Denpasar: SI-LIAK",
    ...
    <meta property="og:title" content="SI-LIAK - MGMP IPAS Kota Denpasar">
    <meta property="og:description" content="Sistem Informasi Learning Integration & Analitik Kinerja (SI-LIAK). Wadah kolaborasi MGMP IPAS Kota Denpasar.">
    <meta property="og:url" content="https://mgmpmulokdps.com/">
    <meta property="og:type" content="website">
    <meta property="og:site_name" content="SI-LIAK MGMP IPAS Denpasar">
    ...
    <div class="features-grid" style="max-width: 100%;">
        ...
        <div class="gallery-card">
            ...
            <div style="padding: 15px 20px; border-top: 4px solid var(--primary);">
                ...
                <p style="margin: 0; font-size: 13px; color: var(--text-muted); display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden; text-align: justify;">Pembahasan dan penyelarasan modul ajar IPAS.</p>
            </div>
        </div>
        <div class="gallery-card">
